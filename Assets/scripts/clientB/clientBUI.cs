...
public class clientBUI : MonoBehaviour {
    GameObject Player;
    GameObject Death;
    ...
    public void addDeathPoint()
    {
        ...
        TextuseMagic.GetComponent<Btext>().usemagicMsgStart();
    ...
    void deathDestroy()
    {
        ...
        TextMagicAfter.GetComponent<Btext>().usemagicMsg2Start();
        Invoke("nextScene", 1f);
    ...
    public void addGoodPointAndNormalPoint()
    {
        ...
        TextNoMagicAfter.GetComponent<Btext>().nomagicMsg();
        Invoke("nextScene", 1f);
    }
    ...
    public void next()
    {
        ...
        TextSelect.GetComponent<Btext>().deathMsgStart();
